...
const projects = [
  ...
  { id: 'proj-9', category: 'AI', tag: 'AI / Control Systems', title: 'AI-Controlled Wind Turbine', desc: 'Built an AI-driven wind turbine control system that optimizes turbine operation using intelligent decision-making and predictive control strategies.', stack: ['Python', 'AI', 'Control Systems'], color: 'var(--rose)', github: 'https://github.com/MeghanaKotharu25/AI-Controlled-wind-turbine' },
  { id: 'proj-10', category: 'Healthcare', tag: 'AI / Accessibility', title: 'MisSpoke', desc: 'A speech and communication assistance platform designed to improve spoken language accessibility through AI-driven speech analysis, pronunciation feedback, and fluency tools.', stack: ['Speech Processing', 'Python', 'ML'], color: 'var(--gold)', github: 'https://github.com/Mrudula-itsjuzme/speak134' },
  { id: 'proj-11', category: 'AI', tag: 'AI / Agents', title: 'Closira AI Agent', desc: 'Built an AI agent project focused on intelligent task orchestration and assistive workflows.', stack: ['Python', 'AI', 'Agents'], color: 'var(--rose)', github: 'https://github.com/MeghanaKotharu25/Closira-AI-agent' },
  { id: 'proj-12', category: 'Cyber', tag: 'Cybersec / DSP', title: 'Audio Watermarking System', desc: 'Implemented a robust audio watermarking framework for embedding and extracting hidden information within audio signals for copyright protection and secure distribution.', stack: ['Signal Processing', 'Python', 'Watermarking'], color: 'var(--cyber)', github: 'https://github.com/git-hima-bling/MFC4_C1_AudioWatermarking' }
];
